...
v_N     = numpy.random.uniform(5.0, 10.0)
v_W     = numpy.random.uniform(5.0, 10.0)
v_NW    = numpy.random.uniform(5.0, 10.0)
v_SW    = numpy.random.uniform(5.0, 10.0)
...
print("CAR W VELOCITY: " + str(v_W))
print("CAR NW VELOCITY: " + str(v_NW))
print("CAR SW VELOCITY: " + str(v_SW))

# MAIN FUNCTION
def main():
    print('Starting Controller Supervisor for CASE experiment state 00...')
